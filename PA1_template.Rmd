...
The **mean** number of steps taken per day is: <span style="color:purple">**`r stepsreport$stepsreportmean`**</span>.

The **median** number of steps taken per day is: <span style="color:purple">**`r stepsreport$stepsreportmedian`**</span>.
...
The interval <span style="color:purple">**`r maxreport$interval`**</span> contains the maximum number of average steps, with <span style="color:purple">**`r maxreport$steps`**</span>.
...
```
There are <span style="color:purple">**`r NAreport`**</span> missing values in the 'steps' column.
...
The original **mean** number of steps taken per day was <span style="color:purple">**`r stepsreport$stepsreportmean`**</span> and the new mean is <span style="color:purple">**`r stepsreportnew$stepsreportmean`**</span>, a difference of <span style="color:purple">**`r stepsreportnew$stepsreportmean - stepsreport$stepsreportmean`**</span>.

The original **median** number of steps taken per day was <span style="color:purple">**`r stepsreport$stepsreportmedian`** </span> and the new median is <span style="color:purple">**`r stepsreportnew$stepsreportmedian`**</span>, a difference of <span style="color:purple">**`r stepsreportnew$stepsreportmedian - stepsreport$stepsreportmedian`**</span>.
